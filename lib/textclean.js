...
/**
 * Formatierungsbefehle aus RTF/Word, die als sichtbarer Text übrig geblieben
 * sind („\sb280Sehr geehrter …“). Auch der HTML-Leser braucht dieses Muster.
 */
export const RTF_LEFTOVERS =
  /\\(?:sb|sa|li|ri|fi|fs|cf|f|lang|expndtw|kerning|deftab)-?\d+|\\(?:pard?|plain|tab|line|ql|qr|qc|qj|widctlpar|nowidctlpar|ulnone|hich|loch|dbch)\b/g;
...
const CLASSES = [
  ...
  {
    code: "rtf",
    label: "RTF-Reste (\\sb280 u. Ä.)",
    // Kommt vor, wenn ein Absender aus Word/RTF nach HTML gewandelt hat und
    // die Formatierungsbefehle als sichtbarer Text stehen geblieben sind.
    // Bewusst eng gefasst: nur bekannte Befehlswörter, mit oder ohne Zahl.
    re: RTF_LEFTOVERS,
    replace: "",
  },
  {
